...
public class OperatorGUI extends JFrame {
    ...
    private Object[] row_couser_list;
    ...
    private void loadCourseModel() {
        ...
        for(Course obj : Course.getList()){
            i = 0;
            row_couser_list[i++] = obj.getId();
            row_couser_list[i++] = obj.getName();
            row_couser_list[i++] = obj.getLang();
            row_couser_list[i++] = obj.getPatika().getName();
            row_couser_list[i++] = obj.getEducator().getName();
            mdl_course_list.addRow(row_couser_list);
        }
    }
